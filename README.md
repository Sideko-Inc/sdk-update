...
1. _Create a Sideko API key_ - In the Sideko UI, click the "API Keys" tab and create an API with scoped access to the API that the SDK is for.
2. _Create a GitHub Token_ - [Follow this guide](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens) from Github to retrieve a GitHub token.
...
| `language`           | Programming language of the repository, see [docs for permitted values](https://docs.sideko.dev/sideko-platform/sideko-api/generate-sdk)                                                         |    ✅    |                      |
...
| `sdk-version`        | Exact version to set the SDK (e.g. `1.4.2`) or a bump version for automatic version incrementing, see [docs for permitted values](https://docs.sideko.dev/sideko-platform/sideko-api/update-sdk) |    ❌    | auto                 |
